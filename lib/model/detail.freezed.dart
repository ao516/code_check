...
abstract class $DetailCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(fromJson: _ownerFromJson) String owner,
...
class _$DetailImpl implements _Detail {
  const _$DetailImpl({
    ...
    @JsonKey(fromJson: _ownerFromJson) required this.owner,
  ...
  @override
  String toString() {
    return 'Detail(name: $name, language: $language, owner: $owner, stars: $stars, watchers: $watchers, forks: $forks, issues: $issues)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$DetailImplToJson(this);
  }
}
...
abstract class _Detail implements Detail {
  const factory _Detail({
    ...
    required final List<String> language,
    @JsonKey(fromJson: _ownerFromJson) required final String owner,
